dashboard_theme <- shinyDashboardThemeDIY(
  ...
  ### header
  ,logoBackColor = "rgb(41, 118, 200)"
  
  ,headerButtonBackColor = "rgb(41, 118, 200)"
  ,headerButtonIconColor = "rgb(255,255,255)"
  ,headerButtonBackColorHover = "rgb(110,30,160)"
  ,headerButtonIconColorHover = "rgb(0,0,0)"
  
  ,headerBackColor = "rgb(41, 118, 200)"
  ...
  ,sidebarSearchIconColor = "rgb(41, 118, 200)"
  ...
  ,sidebarTabTextColorSelected = "rgb(41, 118, 200)"
  ...
  ,tabBoxTabTextColorSelected = "rgb(41, 118, 200)"
